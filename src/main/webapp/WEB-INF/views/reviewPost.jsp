	...
	<main class="flex">
		...
		<div class="center">
			...
			<form:form action="reviewCommit" modelAttribute="review" method="get" class="mb-3">
				...
				<fieldset>
					<div>
						<form:input class="form-control" type="number" path="star" placeholder="★評価"/>
						<form:errors path="star" cssStyle="color: black"/>
					</div>
					<div>
						<form:textarea class="form-control" path="review" placeholder="レビューを記入してください(任意)"/>
